...
/**
 * Replaces the window.prompt()/confirm() calls the old frontend used for
 * every edit. Closes on Escape and on backdrop click, locks background
 * scrolling, and moves focus into the panel when it opens.
 */
