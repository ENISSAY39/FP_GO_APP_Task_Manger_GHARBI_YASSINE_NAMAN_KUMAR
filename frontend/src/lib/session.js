 ...
 * Session storage.
 *
 * The JWT used to be pasted by hand into a text input on the page. It now
 * lives in localStorage and is attached automatically by the API client, so
 * nothing token-related is ever shown in the UI.
 *
